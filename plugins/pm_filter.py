    ...
    if query.data.startswith("file"):
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            [
                             [
                              ...
                              InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/TG_UPDATES1")
                             ]
                            ]
                        )
                    )
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                  ...
                  InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/TG_LINKS_CHANNEL")
                 ]
                ]
            )
        )
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/TG_UPDATES1")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
